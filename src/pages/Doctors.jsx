...
const Doctors = () => {
  ...
  return (
    <div>
      <p className='text-gray-600'>Brouse through the docters speciality. </p>  
      ...
      <div className=' flex flex-col gap-4 text-sm text-gray-600 '>
          ...
          <p onClick={()=> speciality === "Dermatologist" ? navigate("/doctors"): navigate("/doctors/Dermatologist") } className={`w-[94vw] sm:w-auto pl-3 py-1.5 border border-gray-300 rounded transition-all cursor-pointer  ${speciality=== "Dermotologist" ? "bg-indigo-100 Text-black" :"" }`}>Dermatologist</p>
