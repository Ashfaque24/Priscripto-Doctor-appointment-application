  ...
  return (
    <form className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        <p>Please {state ==="Sign Up" ? "sign up" : "Log in"} sign up to book appointments</p>
        {
          state === "Sign Up" &&
...

        {
          ...
          : <p>Create an new account? <span onClick={()=>setState("Sign Up")} className='text-blue-400 underline-cursor-poi'>Click here</span></p>
        }
      </div>
